 ...
 * stands in for is a 16px `v-surface`, so the list visibly re-flowed the moment
...
export function SkeletonCard({ className }: { className?: string }) {
  return (
    <div className={cn("v-surface p-5", className)}>
 ...
 * heights below are the `v-display` and `v-body` steps the real header renders.
 */
